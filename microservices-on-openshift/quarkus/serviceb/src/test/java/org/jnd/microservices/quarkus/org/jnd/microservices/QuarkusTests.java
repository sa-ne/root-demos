...
public class QuarkusTests {
  ...
  public void testHealthEndpoint() {
    given().when().get("/serviceb/health").then().statusCode(200).body(is("OK"));
  }
  ...
  public void testServiceb() {
    given().when().get("/serviceb/echo/test_data").then().statusCode(200).body(is("From Service B : test_data"));
  }
