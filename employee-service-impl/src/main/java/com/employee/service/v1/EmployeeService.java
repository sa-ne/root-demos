 ...
 * 2021-01-28T11:44:54.534-05:00
 * Generated source version: 3.4.2
 *
 */
@WebServiceClient(name = "EmployeeService",
                  wsdlLocation = "file:/Users/samueltauil/Development/workspace/employee-service-impl/src/main/resources/wsdl/employee-service.wsdl",
...
public class EmployeeService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/samueltauil/Development/workspace/employee-service-impl/src/main/resources/wsdl/employee-service.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(EmployeeService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/Users/samueltauil/Development/workspace/employee-service-impl/src/main/resources/wsdl/employee-service.wsdl");
        }
        WSDL_LOCATION = url;
    }
